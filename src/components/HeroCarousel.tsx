...
const HeroCarousel = () => {
  ...
  return (
    <div className="relative h-96 overflow-hidden bg-gradient-to-r from-orange-400 to-red-500">
        ...
        >
          <div className="flex items-center h-full">
            <div className="w-1/2 px-8 lg:px-16 text-white">
              ...
              <button className="bg-white text-orange-600 px-8 py-3 rounded-lg font-semibold hover:bg-orange-50 transition-colors duration-200 transform hover:scale-105">
                {slide.cta}
              </button>
            </div>
